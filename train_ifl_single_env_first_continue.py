...
def main(args):
    ...
    env_score_memo = {}
    epoch = args.epochs_begin
    if epoch in args.update_milestones:
        print("更新环境 2")
        # 接续更新
        with open(f'all_ind_self_{args.epochs_begin}.pkl', 'rb') as file:
            all_ind_self = pickle.load(file)
        with open(f'all_lab_self_{args.epochs_begin}.pkl', 'rb') as file:
            all_lab_self = pickle.load(file)
        with open(f'all_prb_self_{args.epochs_begin}.pkl', 'rb') as file:
            all_prb_self = pickle.load(file)
        with open(f'all_lgt_self_{args.epochs_begin}.pkl', 'rb') as file:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--need_logit_adj_loss', help='是否开启 logits 调整损失', type=bool, default=False)
    ...
    parser.add_argument('--weights_model', type=str,
                        # default='C:/Users/AncilunKiang/Desktop/DesktopFile/研究生日常/炼丹日志/cls/ifl/011/weights/model'
                        #         '-60.pth',
                        default='./model-60-013.pth',
                        help='initial weights path')
    parser.add_argument('--weights_classifier', type=str,
                        # default='C:/Users/AncilunKiang/Desktop/DesktopFile/研究生日常/炼丹日志/cls/ifl/011/weights/classifier'
                        #         '-60.pth',
